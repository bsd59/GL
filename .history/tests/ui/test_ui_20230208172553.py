...
# для затримки вікна після тесту, !!!!! Після перевірки КОМЕНТУЄМО або ВИДАЛЯЄМО зовсім
# import time
...
def test_check_incorrect_username():
    ...
    # затримка вікна після тесту, !!!!! Після перевірки КОМЕНТУЄМО або ВИДАЛЯЄМО зовсім
